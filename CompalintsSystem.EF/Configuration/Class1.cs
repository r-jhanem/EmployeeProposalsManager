...
//        public DefaultData(AppCompalintsContextDB context)
//        {
//            _context = context;
//        }
...
//                    Role = "ادارة شئون الطلاب"
//                };

//                // Before inserting the record
//                await dbContext.Database.ExecuteSqlRawAsync("SET IDENTITY_INSERT UploadsComplaintes ON");

//                // Insert the record with the explicit ID value
...
//                await dbContext.Database.ExecuteSqlRawAsync("SET IDENTITY_INSERT UploadsComplaintes OFF");
