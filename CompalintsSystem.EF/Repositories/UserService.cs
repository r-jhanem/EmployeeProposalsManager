...
namespace CompalintsSystem.EF.Repositories
{
    public class UserService : IUserService
    {
        ...
        // انشاء مستخدم جديد
        public async Task AddUserCompAsync(AddUserViewModel userVM, string currentName, string currentId)
        {
        ...
        public async Task AddUserDepAsync(AddUserViewModel userVM, string currentName, string currentId)
        {
        ...
        // انشاء مستخدم جديد
        public async Task AddUserColgeAsync(AddUserViewModel userVM, string currentName, string currentId)
        {
