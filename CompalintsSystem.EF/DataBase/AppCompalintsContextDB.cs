...
namespace CompalintsSystem.EF.DataBase
{
    public class AppCompalintsContextDB : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                c.HasOne(e => e.Colleges)
                .WithMany(e => e.Users)
                .OnDelete(DeleteBehavior.Restrict);

                c.HasOne(e => e.Departments)
                  .WithMany(e => e.Users)
                  .OnDelete(DeleteBehavior.Restrict);

                c.HasOne(e => e.SubDepartments)
              .WithMany(e => e.Users)
              .OnDelete(DeleteBehavior.Restrict);
            ...
            {
                u.HasOne(e => e.Colleges)
                  .WithMany(e => e.UploadsComplaintes)
                  .OnDelete(DeleteBehavior.Restrict);

                u.HasOne(e => e.Departments)
                .WithMany(e => e.UploadsComplaintes)
                .OnDelete(DeleteBehavior.Restrict);

                u.HasOne(e => e.SubDepartments)
                .WithMany(e => e.UploadsComplaintes)
                .OnDelete(DeleteBehavior.Restrict);
        ...
        public DbSet<Colleges> Collegess { get; set; }
        public DbSet<Departments> Departmentss { get; set; }
        public DbSet<SubDepartments> SubDepartmentss { get; set; }
        ...
        public DbSet<ComplatinClassfaction> ComplatinClassfactions { get; set; }
